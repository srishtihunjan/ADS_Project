...
public class MinHeap {
	...
	public static ArrayList<Node> make_heap(ArrayList<Node> node_array) {
	...
	public static void min_heapify(ArrayList<Node> node_array, int i) {
		int l = i * 2 + 1;
		int r = i * 2 + 2;
		int small;
	...
	public static Node Removemin(ArrayList<Node> node_array) {
		...
		min_heapify(node_array, 0);
		return min;
	}

	public static void Insert(ArrayList<Node> node_array, Node newNode) {
		node_array.add(node_array.size(), newNode);
		minheapIncreaseKey(node_array, newNode);

	}

	public static void minheapIncreaseKey(ArrayList<Node> node_array, Node newNode) {
